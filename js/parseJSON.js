...
//
//   const dynamicFormComponent = Convert.toDynamicFormComponent(json);
//
...
function toDynamicFormComponent(json) {
    return cast(JSON.parse(json), r("DynamicFormComponent"));
}

function dynamicFormComponentToJson(value) {
    return JSON.stringify(uncast(value, r("DynamicFormComponent")), null, 2);
}
...
const typeMap = {
    ...
    "Question": o([
        ...
        { json: "defaultAnswer", js: "defaultAnswer", typ: u(undefined, u(0, null)) },
        { json: "required", js: "required", typ: u(undefined, true) },
        { json: "attrs", js: "attrs", typ: u(undefined, r("Attrs")) },
...
module.exports = {
    "dynamicFormComponentToJson": dynamicFormComponentToJson,
    "toDynamicFormComponent": toDynamicFormComponent,
};
